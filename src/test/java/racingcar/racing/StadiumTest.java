...
public class StadiumTest {
    ...
    @DisplayName("경기 후 결과를 리턴해준다")
    @Test
    public void resultRacingCar() {

        Stadium stadium = new Stadium(new CarCollection("lucas,cyan"), 5, () -> { return 1;} );

        ResultRacingCar resultRacingCar = stadium.resultRacing();

        System.out.println(resultRacingCar.toString());
